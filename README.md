...
👉 **[Launch Interactive Swagger UI Portal](https://activity-tracker-cyen.onrender.com/docs)**
...
The CI/CD pipeline automatically runs type-checking (`tsc --noEmit`) and the Vitest suite via **GitHub Actions** on every commit to prevent regression in production.
